...
ACCESSIONS: list[Item] = [
    Item("1UBQ", "rcsb", note="Ubiquitin — small natural positive-control fold"),
    Item("1L2Y", "rcsb", note="Trp-cage — tiny fast-folding reference"),
    Item("P0DTC2", "uniprot", note="Example UniProt FASTA pull (sequence input demo)"),
]
