...
# ---------------------------------------------------------------------------
# EDIT ONLY THIS for each project. Project 23 = protein-nucleic-acid binder;
...
ACCESSIONS: list[Item] = [
    # Project 23 = a designed/natural protein-nucleic-acid binder. The student chooses the DNA/RNA
    # TARGET MOTIF and a starting protein-NA COMPLEX template. Candidates — VERIFY on RCSB in Week 1.
    Item("1MEY", "rcsb", note="Designed zinc-finger-DNA complex; protein-NA recognition template (VERIFY)"),
    # Add the complex that matches YOUR chosen motif, e.g. an RNA-hairpin-protein complex, and (optionally)
    # a UniProt pull for a natural NA-binding reference. The scrambled-motif control is generated in code,
    # not fetched. Do NOT commit large structures — fetch + log provenance here.
]
