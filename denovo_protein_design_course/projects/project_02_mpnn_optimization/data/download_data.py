...
# ---------------------------------------------------------------------------
# EDIT ONLY THIS for each project (Project 02 — ProteinMPNN optimization).
# These fetch the NATURAL REFERENCE MONOMERS used as recovery/recapitulation
# baselines for the MPNN sweep. Treat each accession as "candidate — verify on
# RCSB/UniProt in Week 1" (PDB entries are occasionally superseded).
#
# The DE NOVO BACKBONES (the real subjects of the sweep) do NOT come from
# single-accession fetches — assemble them from Project 03 outputs or a public
# de novo design set and drop them into data/inputs/ (see data/README.md).
# ---------------------------------------------------------------------------
ACCESSIONS: list[Item] = [
    # Natural reference monomers for Project 02. Candidates — VERIFY on RCSB in Week 1.
    Item("1UBQ", "rcsb", note="Ubiquitin — small robust alpha/beta fold (recovery/recap baseline)"),
    Item("1L2Y", "rcsb", note="Trp-cage — tiny fast-folder"),
    Item("1ENH", "rcsb", note="Engrailed homeodomain — small all-alpha"),
    Item("2GB1", "rcsb", note="Protein G B1 domain — classic alpha/beta"),
    Item("1MJC", "rcsb", note="Cold-shock protein — beta-barrel"),
    # Add a few more spanning the fold classes your de novo backbones cover.
    # De novo backbones come from Project 03 / public design sets, not from here.
]
