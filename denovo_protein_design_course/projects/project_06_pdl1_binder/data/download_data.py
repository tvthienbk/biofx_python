...
# ---------------------------------------------------------------------------
# EDIT ONLY THIS for each project. These are the Project 06 inputs (PD-1/PD-L1
# complex). Treat each accession as "candidate — verify on RCSB/UniProt in Week 1"
# (the catalog flags which may be superseded). The PD-L1 ectodomain HOTSPOTS come
# from the PD-1 interface in these complexes: isolate the PD-L1 chain's IgV domain,
# remove PD-1/waters/heteroatoms, and list the PD-L1 residues contacting PD-1 as
# your design hotspots (the competitive epitope). See data/README.md.
# ---------------------------------------------------------------------------
ACCESSIONS: list[Item] = [
    # Human PD-1/PD-L1 complexes — CANDIDATES, verify on RCSB in Week 1.
    Item("4ZQK", "rcsb", note="candidate human PD-1/PD-L1 complex — defines the PD-1-binding face of PD-L1 (hotspots from this interface)"),
    Item("5O45", "rcsb", note="candidate PD-1/PD-L1 complex — cross-check the epitope/hotspots against 4ZQK"),
    # Optional: pull the human PD-L1 (CD274) sequence for reference / numbering.
    # Item("Q9NZQ7", "uniprot", note="Human PD-L1 / CD274 sequence (verify) — domain numbering reference"),
]
