...
# ---------------------------------------------------------------------------
# EDIT ONLY THIS for each project. These are the Project 01 inputs as an example;
...
ACCESSIONS: list[Item] = [
    # Natural positive-reference folds for Project 01. Candidates — VERIFY on RCSB in Week 1.
    Item("1UBQ", "rcsb", note="Ubiquitin — small robust alpha/beta fold"),
    ...
    # Add 5+ more spanning the fold classes your cohort will design.
    # Labeled de novo designs (with experimental outcomes) go in dataset.csv, not here —
    # those come from paper supplementary data, not a single-accession fetch.
]
