"""Minimal recovery test: does the standardized model recover alpha, beta, sigma?
...
def test_recovers_standardized_coefficients():
    data = generate()
...
if __name__ == "__main__":
    test_recovers_standardized_coefficients()
